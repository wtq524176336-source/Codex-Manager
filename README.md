...
- 本地网关：为 Codex CLI、Gemini CLI、Claude Code 和第三方工具提供统一 OpenAI 兼容入口；Gemini 请求可转发到 `/v1/responses`，并兼容 SSE / Responses WebSocket、tools、MCP、skill、请求总超时与流式空闲超时等调用链路
