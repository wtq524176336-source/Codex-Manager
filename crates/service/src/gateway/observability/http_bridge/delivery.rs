...
use super::super::{ResponseAdapter, ToolNameRestoreMap};
use super::{
    ...
    push_trace_id_header, usage_has_signal, ChatCompletionsFromResponsesSseReader,
...
fn compatibility_stream_content_type(response_adapter: ResponseAdapter) -> &'static str {
    match response_adapter {
...
pub(crate) fn respond_with_upstream(
    ...
    if response_adapter != ResponseAdapter::Passthrough {
        ...
        replace_content_type_header(
            &mut headers,
            compatibility_stream_content_type(response_adapter),
        );
        match response_adapter {
            ResponseAdapter::ChatCompletionsFromResponses => {
    ...
    match response_adapter {
        ...
        ResponseAdapter::ChatCompletionsFromResponses
        | ResponseAdapter::ImagesB64JsonFromResponses
        | ResponseAdapter::ImagesUrlFromResponses => unreachable!(),
    }
}
...
fn resolve_stream_keepalive_frame(
    ...
    match response_adapter {
        ...
        ResponseAdapter::ChatCompletionsFromResponses
        | ResponseAdapter::ImagesB64JsonFromResponses
        | ResponseAdapter::ImagesUrlFromResponses => SseKeepAliveFrame::Comment,
    }
}
...
mod tests {
    use super::{
        ...
        convert_responses_body_to_chat_completions, convert_responses_body_to_images,
        force_openai_responses_stream_content_type, Header, ImagesResponseFormat,
    };
    use serde_json::json;
