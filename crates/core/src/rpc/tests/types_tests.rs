...
fn account_summary_serialization_matches_compact_contract() {
    let summary = AccountSummary {
        ...
        current_window_cost_usd: 0.12,
        current_window_started_at: Some(1_744_982_000),
        current_window_resets_at: Some(1_745_000_000),
        primary_window_cost_usd: 0.12,
        primary_window_started_at: Some(1_744_982_000),
        primary_window_resets_at: Some(1_745_000_000),
        secondary_window_cost_usd: 0.34,
        secondary_window_started_at: Some(1_744_395_200),
        secondary_window_resets_at: Some(1_745_000_000),
